...
export type DatePreset = '7' | '15' | '30' | 'custom';
...
// Resolve a preset (relative to today) to a concrete date range. 'custom' uses
// the caller's own from/to inputs (blank → unbounded on that side).
